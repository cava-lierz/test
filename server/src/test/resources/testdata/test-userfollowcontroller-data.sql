...
INSERT INTO users (id, username, role, is_disabled, reported_count, is_profile_public, is_deleted) VALUES
  (1, 'user1', 'USER', false, 0, true, false),
  (2, 'user2', 'USER', false, 0, true, false),
  (3, 'deletedUser', 'USER', false, 0, true, true),
  (4, 'disabledUser', 'USER', true, 0, true, false);
ALTER TABLE users ALTER COLUMN id RESTART WITH 5;
-- 用户认证
INSERT INTO user_auths (id, email, password) VALUES
  (1, 'user1@example.com', 'testpass'),
  (2, 'user2@example.com', 'testpass'),
  (3, 'deletedUser@example.com', 'testpass'),
  (4, 'disabledUser@example.com', 'testpass'); 