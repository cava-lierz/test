...
-- 聊天房间
INSERT INTO chat_rooms (id, name, type, is_deleted) VALUES (1, 'testRoom', 'REALNAME', false);
ALTER TABLE chat_rooms ALTER COLUMN id RESTART WITH 2;
-- 房间成员
INSERT INTO chat_room_users (id, chat_room_id, user_id, version) VALUES (1, 1, 2, 0);
ALTER TABLE chat_room_users ALTER COLUMN id RESTART WITH 2;