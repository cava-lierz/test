...
INSERT INTO users (id, username, role, is_disabled, reported_count, is_profile_public, is_deleted) VALUES
  ...
  (2, 'expert1', 'EXPERT', false, 0, true, false),
  (3, 'user1', 'USER', false, 0, true, false);
ALTER TABLE users ALTER COLUMN id RESTART WITH 4;

-- 用户认证信息
INSERT INTO user_auths (id, email, password) VALUES
  (1, 'admin@example.com', 'testpass'),
  (2, 'expert1@example.com', 'testpass'),
  (3, 'user1@example.com', 'testpass');

-- 专家
INSERT INTO experts (id, user_id, name, specialty, contact, status) VALUES
  (1, 2, '专家A', '心理', 'contactA', 'ACTIVE');
ALTER TABLE experts ALTER COLUMN id RESTART WITH 2;

-- 专家排班
INSERT INTO expert_schedules (id, expert_id, schedule_json) VALUES
  (1, 1, '{}');
ALTER TABLE expert_schedules ALTER COLUMN id RESTART WITH 2;