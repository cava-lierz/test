...
INSERT INTO users (id, username, role, is_disabled, reported_count, is_profile_public, is_deleted) VALUES
  ...
  (2, 'admin', 'ADMIN', false, 0, true, false);
ALTER TABLE users ALTER COLUMN id RESTART WITH 3;

-- 用户认证
INSERT INTO user_auths (id, email, password) VALUES
  (1, 'user1@example.com', 'testpass'),
  (2, 'admin@example.com', 'testpass');

-- 通知
INSERT INTO notifications (id, notification_type, receiver_id, created_at, is_read) VALUES
  (1, 'system', 1, CURRENT_TIMESTAMP, false);
